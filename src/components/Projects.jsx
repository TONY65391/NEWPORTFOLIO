    ...
    return(
        <section className={`${ theme ? "bg-black" : "bg-white" }`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:w-[95%] mx-auto py-9 margin-0 pt-9 gap-4">
                ...
                <Project src={Cryptgo} role="Full-Stack Developer" title="CRYPGO Exchange | Cryptocurreny Website" desc="A cryptocurrency website where users can convert digital currencies into hard currency at a relatively low rate." display5="hidden" display6="hidden" display10="hidden" display12="hidden" display13="hidden"/>
