...
export default function Header({theme, setTheme}){
    ...
    return(
        <header className={`HEADER ${ theme ? "border-rgba(245,222,179,0.322) border-white" : "border-black bg-white" } border-1 flex p-2 rounded-4xl w-fit fixed left-1/2 -translate-x-1/2 top-5`}>
