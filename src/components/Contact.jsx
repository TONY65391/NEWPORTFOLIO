    ...
    return(
        <section className={`${ props.theme ? "text-white bg-black" : "text-black bg-white" }`}>
            ...
            <div className={`${ props.theme ? "bg-[rgb(26,25,25)]" : "bg-black" } w-fit md:w-[95%] mx-auto my-9 flex flex-col items-center rounded-4xl py-9 px-9`}>
                ...
                <p className="text-white my-5 md:w-3/4 w-full opacity-40 md:text-xl text-lg text-center">I'm currently open to freelance contracts, full-time roles, and interesting collaborations. If you have a project in mind or just want to talk, I'd love to hear from you.</p>

                <Link className="FONT hover:gap-4 flex items-center gap-1 my-3 md:my-5 lg:px-9 lg:py-5 md:px-5 md:py-4 px-4 py-3 bg-white text-black rounded-3xl font-bold"><span>Get In Touch</span> <span>→</span></Link>
            </div>
        </section>
    )
}